...
@JsonSubTypes({ @JsonSubTypes.Type(value = StringParamValue.class, name = Param.STRING),
		@JsonSubTypes.Type(value = IntegerParamValue.class, name = Param.INTEGER),
		@JsonSubTypes.Type(value = LongParamValue.class, name = Param.LONG),
		@JsonSubTypes.Type(value = DoubleParamValue.class, name = Param.DOUBLE),
